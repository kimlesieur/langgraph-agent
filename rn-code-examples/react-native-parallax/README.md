# React Native Parallax Image Scroll

This code is part of the [Galaxies.dev React Native Parallax Image Scroll Tutorial](https://galaxies.dev/react-native-parallax-image).
